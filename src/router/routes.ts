...
export function RegisterRoutes(app: express.Router) {
  ...
  app.post(
    ...
    ...fetchMiddlewares<RequestHandler>(
      CreateCategoryController.prototype.handler
    ),

    async function CreateCategoryController_handler(
      request: any,
      response: any,
      next: any
    ) {
      ...
      try {
        ...
        const controller: any = await container.get<CreateCategoryController>(
        ...
        const promise = controller.handler.apply(
          controller,
  ...
  app.delete(
    ...
    ...fetchMiddlewares<RequestHandler>(
      DeleteCategoryController.prototype.handler
    ),

    async function DeleteCategoryController_handler(
      request: any,
      response: any,
      next: any
    ) {
      ...
      try {
        ...
        const controller: any = await container.get<DeleteCategoryController>(
  ...
  app.get(
    ...
    ...fetchMiddlewares<RequestHandler>(
      FindCategoriesController.prototype.handler
    ),

    async function FindCategoriesController_handler(
      request: any,
      response: any,
      next: any
    ) {
      ...
      try {
        ...
        const controller: any = await container.get<FindCategoriesController>(
  ...
  app.get(
    ...
    ...fetchMiddlewares<RequestHandler>(
      FindCategoryController.prototype.handler
    ),

    async function FindCategoryController_handler(
      request: any,
      response: any,
      next: any
    ) {
      ...
      try {
        ...
        const controller: any = await container.get<FindCategoryController>(
  ...
  app.put(
    ...
    ...fetchMiddlewares<RequestHandler>(
      UpdateCategoryController.prototype.handler
    ),

    async function UpdateCategoryController_handler(
      request: any,
      response: any,
      next: any
    ) {
      ...
      try {
        ...
        const controller: any = await container.get<UpdateCategoryController>(
  ...
  app.post(
    ...
    async function CreatePostController_handler(
      request: any,
      response: any,
      next: any
    ) {
      ...
      try {
        ...
        const controller: any = await container.get<CreatePostController>(
  ...
  app.delete(
    ...
    async function DeletePostController_handler(
      request: any,
      response: any,
      next: any
    ) {
      ...
      try {
        ...
        const controller: any = await container.get<DeletePostController>(
  ...
  app.get(
    ...
    ...fetchMiddlewares<RequestHandler>(
      FindCategoryPostsController.prototype.handler
    ),

    async function FindCategoryPostsController_handler(
      request: any,
      response: any,
      next: any
    ) {
      ...
      try {
        ...
        const controller: any =
          await container.get<FindCategoryPostsController>(
            FindCategoryPostsController
          );
        if (typeof controller['setStatus'] === 'function') {
          controller.setStatus(undefined);
        }
  ...
  app.get(
    ...
    async function FindPostController_handler(
      request: any,
      response: any,
      next: any
    ) {
      ...
      try {
        ...
        const controller: any = await container.get<FindPostController>(
          FindPostController
        );
        if (typeof controller['setStatus'] === 'function') {
          controller.setStatus(undefined);
  ...
  app.get(
    ...
    async function FindPostsController_handler(
      request: any,
      response: any,
      next: any
    ) {
      ...
      try {
        ...
        const controller: any = await container.get<FindPostsController>(
          FindPostsController
        );
        if (typeof controller['setStatus'] === 'function') {
          controller.setStatus(undefined);
  ...
  app.get(
    ...
    ...fetchMiddlewares<RequestHandler>(
      FindUserPostsController.prototype.handler
    ),

    async function FindUserPostsController_handler(
      request: any,
      response: any,
      next: any
    ) {
      ...
      try {
        ...
        const controller: any = await container.get<FindUserPostsController>(
          FindUserPostsController
        );
        if (typeof controller['setStatus'] === 'function') {
          controller.setStatus(undefined);
        }
  ...
  app.put(
    ...
    async function UpdatePostController_handler(
      request: any,
      response: any,
      next: any
    ) {
      ...
      try {
        ...
        const controller: any = await container.get<UpdatePostController>(
  ...
  app.post(
    ...
    async function CreateUserController_handler(
      request: any,
      response: any,
      next: any
    ) {
  ...
  app.get(
    ...
    async function FindUserController_handler(
      request: any,
      response: any,
      next: any
    ) {
      ...
      try {
        ...
        const controller: any = await container.get<FindUserController>(
          FindUserController
        );
        if (typeof controller['setStatus'] === 'function') {
          controller.setStatus(undefined);
  ...
  app.post(
    ...
    async function LoginController_handler(
      request: any,
      response: any,
      next: any
    ) {
      ...
      try {
        ...
        const controller: any = await container.get<LoginController>(
          LoginController
        );
        if (typeof controller['setStatus'] === 'function') {
          controller.setStatus(undefined);
  ...
  app.put(
    ...
    async function UpdateUserController_handler(
      request: any,
      response: any,
      next: any
    ) {
